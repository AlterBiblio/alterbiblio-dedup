...
export const UI = {
  es: {
    ...
    s1embase: "<b>En Embase, descarga en RIS.</b> Si exportas en CSV, marca <b>Fields by: Row</b>: la opción <i>Column</i> pierde el tipo de documento, junta todos los autores en una sola cadena e incrusta la cita completa en el nombre de la revista. Las cifras de deduplicación salen iguales, pero las referencias que exportas después son de peor calidad.",
  ...
  en: {
    ...
    s1embase: "<b>From Embase, download RIS.</b> If you export CSV, choose <b>Fields by: Row</b>: the <i>Column</i> option drops the publication type, collapses all authors into a single string and embeds the full citation in the journal name. Deduplication counts come out the same, but the references you export afterwards are of poorer quality.",
