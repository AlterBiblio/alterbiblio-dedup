...
const L = {
  es: {
    ...
    h3: ["Concepto", "Valor"],
    dvList: '"Sí,No,Quizás"',
    posDe: (t, reason, conf) => `Posible duplicado de «${t}» — ${reason} · Confianza: ${conf}`,
    r3: {
      ...
      posibles: "Posibles duplicados anotados (conservados)",
    },
